...
function installQuestions() {
    ...
    if [[ "${AUTO_INSTALL,,}" == "y" ]]; then
        ...
        SERVER_AWG_I1="<r 2><b 0x01000001000000000000076578616d706c6503636f6d0000010001><r 8>"
        SERVER_AWG_I2="<r 2><b 0x81800001000100000000076578616d706c6503636f6d0000010001c00c000100010000003c00045db8d822><r 16>"
    ...
    until [[ ${SERVER_AWG_I1} =~ $re ]]; do
        read -rp "AmneziaWG require I1, read https://docs.amnezia.org/documentation/amnezia-wg/#how-it-works : " -e -i "<r 2><b 0x01000001000000000000076578616d706c6503636f6d0000010001><r 8>" SERVER_AWG_I1
    done
    # I2
    until [[ ${SERVER_AWG_I2} =~ $re ]]; do
        read -rp "AmneziaWG require I2, read https://docs.amnezia.org/documentation/amnezia-wg/#how-it-works : " -e -i "<r 2><b 0x81800001000100000000076578616d706c6503636f6d0000010001c00c000100010000003c00045db8d822><r 16>" SERVER_AWG_I2
    done
...
H4 = ${SERVER_AWG_H4}
I1 = ${SERVER_AWG_I1}
I2 = ${SERVER_AWG_I2}" >"${SERVER_AWG_CONF}"
...
function newClient() {
    ...
    if [[ "${AUTO_INSTALL,,}" == "y" ]]; then
        ...
        until [[ ${CLIENT_NAME} =~ ^[a-zA-Z0-9_-]+$ && ${CLIENT_EXISTS} == '0' && ${#CLIENT_NAME} -lt 33 ]]; do
